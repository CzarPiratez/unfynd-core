...
| Ordinary Find / recall + Why (explain from stored evidence) | Yes (§4 principles; Find as capability) | **shipped** (keyword Find + Why); **partial** (Find by meaning) | Keyword Find with evidence-backed Why is shipped. Find-by-meaning is a **candidate** path; not a marketing AVAILABLE / SLA claim. |
...
| Marketing AVAILABLE semantic recall / SLA | Non-claim (§9) | **not shipped** / **not claimed** | Emulator work ≠ AVAILABLE. |
